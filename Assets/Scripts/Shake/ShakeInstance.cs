namespace AdventureGame.Shake
{
    ...
    public class ShakeInstance
    {
        ...
        /// </summary>
        public ShakeParameters ShakeParameters { get; }
        ...
        public ShakeInstance(ShakeParameters parameters)
        {
        ...
        public ShakeResult UpdateShake(float deltaTime)
        {
            ...
            {
                positionNoise = ShakeParameters.noiseSettings.PositionNoise,
                orientationNoise = ShakeParameters.noiseSettings.OrientationNoise,
                power = fadeTransition
            };
