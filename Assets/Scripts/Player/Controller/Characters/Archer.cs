...
namespace AdventureGame.Player
{
    public class Archer : MonoBehaviour
    {
        ...
        [SerializeField] private Transform aimRaycastPoint;
        [Space]
        ...
        public void OnShootArrow()
        {
            ...
            bool successful = Physics.Raycast(aimRaycastPoint.position, aimRaycastPoint.forward, out RaycastHit hit, arrowMaxDistance, hittableLayer);
            Quaternion rotation;
            if (successful)
            {
